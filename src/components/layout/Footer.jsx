  ...
  return (
    <div className="border-t border-white/10 pt-12 pb-6 text-center w-full relative z-10">
      ...
      <div className="flex justify-center gap-6 mb-8">
        <a href="https://www.instagram.com/tekronfest/" target="_blank" rel="noopener noreferrer" className="w-16 h-16 border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-purple-500 hover:text-purple-400 transition-all">
