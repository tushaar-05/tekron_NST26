        ...
        <div className="relative w-screen h-screen overflow-hidden bg-black font-['VT323',_monospace] selection:bg-purple-500 selection:text-white perspective-[2000px]">
            ...
            <div className="absolute inset-0 pointer-events-none z-20 overflow-hidden">
                ...
                <motion.img
                    ...
                    alt=""
                    className="absolute -top-20 -left-20 w-[400px] mix-blend-screen param-cloud"
                ...
                <motion.img
                    ...
                    alt=""
                    className="absolute -top-32 -right-10 w-[500px] mix-blend-screen param-cloud"
                ...
                <motion.img
                    ...
                    alt=""
                    className="absolute -bottom-20 -left-10 w-[450px] mix-blend-screen param-cloud"
                ...
                <motion.img
                    ...
                    alt=""
                    className="absolute -bottom-32 -right-20 w-[550px] mix-blend-screen param-cloud"
